...
private: System::Void btnTotal_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	labelMessage->Text = "Chaque personne re�oit un nombre de points �gal � la somme de ses cartes";
	int valeur = 0;
...
private: System::Void btnValeurChanseuce_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	string message = "Tous ceux qui ont une carte poss�dant la valeur chanceuse obtiennent cette valeur\n";
